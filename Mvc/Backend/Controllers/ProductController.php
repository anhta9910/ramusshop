<?php 
	//load file model
	include "Mvc/Backend/Models/ProductModel.php";
	class ProductController extends Controller{
		//khai bao de su dung ProductModel
		use ProductModel;
		public function index(){
			...
			return $this->renderHTML("Mvc/Backend/Views/ProductView.php",array("data"=>$data,"numPage"=>$numPage));
		}
		//edit
		public function edit(){
			...
			//goi view
			$this->renderHTML("Mvc/Backend/Views/AddEditProductView.php",array("record"=>$record,"formAction"=>$formAction));
		}
		//do edit
		...
		public function add(){
			...
			//goi view
			$this->renderHTML("Mvc/Backend/Views/AddEditProductView.php",array("formAction"=>$formAction));
		}
		//do add
