<?php 
	include "Mvc/Backend/Models/OrderModel.php";
	class OrderController extends Controller{
		...
		public function index(){
			...
			$this->renderHTML("Mvc/Backend/Views/OrderView.php",array("data"=>$data,"numPage"=>$numPage));
		}
		//chi tiet don hang
		public function orderDetail(){
			...
			//goi view, truyen du lieu ra view
			$this->renderHTML("Mvc/Backend/Views/OrderDetailView.php",array("data"=>$data,"id"=>$id));
		}
		//xac nhan giao hang
