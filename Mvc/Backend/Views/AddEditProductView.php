    ...
    <div class="panel panel-primary">
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo $formAction; ?>">
            ...
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2"></div>
                <div class="col-md-10">
                    <input type="checkbox" <?php if(isset($record->salesproduct)&&$record->salesproduct==1): ?> checked <?php endif; ?> name="salesproduct" id="salesproduct"> <label for="salesproduct">Sales Product</label>
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
